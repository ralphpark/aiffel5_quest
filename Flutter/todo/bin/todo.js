...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      new A.TodoApp(type$.UListElement._as(document.querySelector("#todo-list")))._initializeUI$0();
    },
    Todo: function Todo(t0, t1) {
      this.title = t0;
      this.content = t1;
      this.__Todo_timestamp_A = $;
    },
    TodoApp: function TodoApp(t0) {
      this.todoList = t0;
    },
    TodoApp__initializeUI_closure: function TodoApp__initializeUI_closure(t0, t1, t2) {
      this.$this = t0;
      this.titleInput = t1;
      this.contentInput = t2;
    },
    TodoApp__addTodo_closure: function TodoApp__addTodo_closure(t0, t1) {
      this.$this = t0;
      this.newTodo = t1;
    },
  ...
  A.TodoApp.prototype = {
    _initializeUI$0() {
      var t1 = document,
        titleInput = type$.InputElement._as(t1.querySelector("#todo-title")),
        contentInput = type$.TextAreaElement._as(t1.querySelector("#todo-content")),
        t2 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(type$.ButtonElement._as(t1.querySelector("#add-todo")), "click", t2._eval$1("~(1)?")._as(new A.TodoApp__initializeUI_closure(this, titleInput, contentInput)), false, t2._precomputed1);
    },
    _addTodo$1(todo) {
      var t2, t3,
        t1 = document,
        newTodo = t1.createElement("li"),
        list = newTodo.classList;
      list.contains("todo-item").toString;
      list.add("todo-item");
      t2 = t1.createElement("h3");
      t2.toString;
      B.HeadingElement_methods.set$text(t2, todo.title);
      list = t2.classList;
      list.contains("todo-title").toString;
      list.add("todo-title");
      newTodo.appendChild(t2).toString;
      t2 = t1.createElement("p");
      t2.toString;
      B.ParagraphElement_methods.set$text(t2, todo.content);
      list = t2.classList;
      list.contains("todo-content").toString;
      list.add("todo-content");
      newTodo.appendChild(t2).toString;
      t2 = t1.createElement("p");
      t2.toString;
      t3 = todo.__Todo_timestamp_A;
      t3 === $ && A.throwLateFieldNI("timestamp");
      B.ParagraphElement_methods.set$text(t2, "Created at: " + t3.toString$0(0));
      list = t2.classList;
      list.contains("todo-timestamp").toString;
      list.add("todo-timestamp");
      newTodo.appendChild(t2).toString;
      t1 = t1.createElement("button");
      t1.toString;
      B.ButtonElement_methods.set$text(t1, "Delete");
      list = t1.classList;
      list.contains("delete-button").toString;
      list.add("delete-button");
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(t1, "click", t2._eval$1("~(1)?")._as(new A.TodoApp__addTodo_closure(this, newTodo)), false, t2._precomputed1);
      newTodo.appendChild(t1).toString;
      this.todoList.appendChild(newTodo).toString;
    }
  };
  A.TodoApp__initializeUI_closure.prototype = {
    call$1($event) {
      var t1, t2, titleText, t3, contentText;
      type$.MouseEvent._as($event);
      t1 = this.titleInput;
      t2 = t1.value;
      titleText = t2 == null ? null : B.JSString_methods.trim$0(t2);
      if (titleText == null)
        titleText = "";
      t2 = this.contentInput;
      t3 = t2.value;
      contentText = t3 == null ? null : B.JSString_methods.trim$0(t3);
      if (contentText == null)
        contentText = "";
      if (titleText.length !== 0 && contentText.length !== 0) {
        t3 = new A.Todo(titleText, contentText);
        t3.__Todo_timestamp_A = new A.DateTime(Date.now(), false);
        this.$this._addTodo$1(t3);
  ...
  A.TodoApp__addTodo_closure.prototype = {
    call$1($event) {
      var t1;
      type$.MouseEvent._as($event);
      t1 = this.$this.todoList;
      t1.children.toString;
      A._ChildrenElementList__remove(t1, this.newTodo);
    },
    $signature: 3
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.ListBase, A.DateTime, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription, A.ImmutableListMixin, A.FixedSizeListIterator, A.Todo, A.TodoApp]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.DomTokenList, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.TodoApp__initializeUI_closure, A.TodoApp__addTodo_closure]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.ButtonElement, A.FormElement, A.HeadingElement, A.InputElement, A.LIElement, A.ParagraphElement, A.SelectElement, A.TextAreaElement, A.UListElement]);
